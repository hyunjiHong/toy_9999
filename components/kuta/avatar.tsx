    ...
    >
      <div className={cn("rounded-md p-0.5", isMe && "ring-2 ring-foreground")}>
        <svg width="48" height="56" viewBox="0 0 48 56" role="img" aria-hidden>
          ...
          <path d="M18 21 q2.5 2.5 5 0" fill="none" stroke="#3A2A22" strokeWidth="2" strokeLinecap="round" />
          <path d="M25 21 q2.5 2.5 5 0" fill="none" stroke="#3A2A22" strokeWidth="2" strokeLinecap="round" />
          <circle cx="17" cy="25" r="2.4" fill="#F4A6B0" opacity="0.8" />
          <circle cx="31" cy="25" r="2.4" fill="#F4A6B0" opacity="0.8" />
          <path d="M21.5 26.5 q2.5 2.5 5 0" fill="none" stroke="#C86B7A" strokeWidth="1.4" strokeLinecap="round" />
          ...
          <rect x="27" y="38" width="13" height="13" rx="2" fill="#FFFFFF" stroke="#D8CFC0" />
          <rect x="29" y="40" width="9" height="4" fill={cup} />
          <path d="M40 41 h2 a2 2 0 0 1 0 6 h-2" fill="none" stroke="#D8CFC0" strokeWidth="1.5" />
        </svg>
      </div>
